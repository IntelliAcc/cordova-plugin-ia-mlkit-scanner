...
public final class MLKitBarcodeCaptureActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        _Preview =
                (MLKitCameraSourcePreview)findViewById(getResources().getIdentifier("preview", "id", getPackageName()));
        _Preview.ViewFinderWidth = ViewFinderWidth;
        _Preview.ViewFinderHeight = ViewFinderHeight;
        _GraphicOverlay = (MLKitGraphicOverlay<MLKitBarcodeGraphic>)findViewById(getResources().getIdentifier(
                "graphicOverlay",
                "id",
                getPackageName()));
        ...
        EditText txtBarcode =
                (EditText)findViewById(getResources().getIdentifier("txtBarcode", "id", getPackageName()));
        Button clickButton =
                (Button)findViewById(getResources().getIdentifier("submitBarcode", "id", getPackageName()));
